...
export const INITIATIVES_HEAD = {
  ...
  soon: "ויש עוד כלים בדרך. מי שמשאיר פרטים למטה ישמע עליהם ראשון.",
} as const
...
export const AUDITOR_PANE = {
  ...
  note: "הסריקה הראשונית בחינם, ואת הממצאים עוברים יחד בטלפון. למי שרוצה להעמיק, יש גם סריקה מלאה ומלווה כשירות מתמשך.",
} as const
